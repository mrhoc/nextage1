<?php get_header() ?>
	<main>
		<div class="section hero">
			<figure class="fluid">
				<picture>
					<source srcset="<?php echo get_bloginfo('template_directory') ?>/images/bg_fv_sp.jpg"
			...
			<div class="container">
				<figure class="figure">
					<picture>
						<source srcset="<?php echo get_bloginfo('template_directory') ?>/images/fv_catch_sp.png"
						        media="(max-width: 750px)">
						<img src="<?php echo get_bloginfo('template_directory') ?>/images/fv_catch_pc.png"
						     alt="Work To Create The Future.未来を創造する仕事">
					</picture>
				</figure>
			</div>
		</div>
		<section class="section about about1">
			<div class="container">
				...
				?>
				<?php if (have_posts()) : ?>
				<h2 class="title mbsp-20 center">
					<picture>
						<source srcset="<?php echo get_bloginfo('template_directory') ?>/images/ttl_new_sp.png"
						        media="(max-width: 750px)">
						<img src="<?php echo get_bloginfo('template_directory') ?>/images/ttl_new_pc.png" alt="We Are">
					</picture>
				</h2>
				<ul class="list-news">
				...
				<div class="btn-home center">
					<a href="/news" class="btn-comp01">すべてのNEWSを見る</a>
				</div>
